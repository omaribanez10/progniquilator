<?php
	...
	/*
	  ...
	  Autor: Jhonatan Mantilla Arenas - 19/09/2019
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_servicios.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reportes de Servicios</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal volumen">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte General de Servicios</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_servicios_excel.php" method="post" style="display:none;" target="_blank">
