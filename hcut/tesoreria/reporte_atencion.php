<?php
	session_start();
	/*
	  Reporte general de atenciones y pagos
	  Autor: Feisar Moreno - 01/09/2016
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_atencion.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reportes de atenciones</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal volumen">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte General de Atenciones</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_atencion_excel.php" method="post" style="display:none;" target="_blank">
