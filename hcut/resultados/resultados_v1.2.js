...
function imprimir_registro_resultados(id_hc) {
	$("#d_cargando_resultados").css("display", "block");
	var params = "id_hc=" + id_hc;
	
	llamarAjax("../historia_clinica/impresion_historia_clinica.php", params, "d_impresion_hc", "continuar_imprimir_registro_resultados();");
}

function continuar_imprimir_registro_resultados() {
	var ruta = $("#hdd_ruta_arch_hc_pdf").val();
	
	window.open("../funciones/abrir_pdf.php?ruta=" + ruta + "&nombre_arch=registro_hc.pdf", "_blank");
	$("#d_cargando_resultados").css("display", "none");
}
