...
function llamarAjax(strURL, strPARAM, objDestino, funcion, idBarraProgreso) {
    ...
    try {
        ...
        updateObj("<div><img src='../imagenes/ajax-loader.gif' style='max-width: 100%;'></img></div>", objDestino);
		...
		eval("self.xmlHttpReq" + contAjax + ".onreadystatechange = function() { \n\
			if (self.xmlHttpReq" + contAjax + ".readyState == 4) { \n\
				...
				updateObj(\"<div><img src='../imagenes/ajax-loader.gif' style='max-width: 10%;'></img></div>\", '" + objDestino + "', self.xmlHttpReq" + contAjax + ".readyState);\n\
			} \n\
		}");
