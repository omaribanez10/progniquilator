                    ...
                    for ($index = 1; $index < 2; $index++) {
                        ...
                        if ($columnas == 8) {
                            ...
                            for ($index = 1; $index <= $filas; $index++) {
                                ...
                                $cod_servicio = trim($arr_dato[1]);
                                $nombre_servicio = (trim($arr_dato[2]));
                                $cod_siesa = trim($arr_dato[3]);
                                $tipo_servicio = trim($arr_dato[4]);
                                $tipo_servicio_p = (trim($arr_dato[5]));
                                $cod_und_negocio = trim($arr_dato[6]);
                                $cod_centro_costos = (trim($arr_dato[7]));
                                ...
                                if ($contador < 1000) {
                                    ...
                                    if ($cod_siesa != "") {
                                        ...
                                        $arr_datos .= $autoincremental.";".$cod_servicio.";".trim($nombre_servicio).";".$cod_siesa.";".$tipo_servicio.";".$tipo_servicio_p.";".
                                        $cod_und_negocio.";".$cod_centro_costos;
                                    }
                                } else {
                                    if ($arr_datos != "") {
                                        $arr_datos .= "|";
